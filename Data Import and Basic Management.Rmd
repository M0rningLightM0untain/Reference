...
#separating col into multiple
data5 <- data5 %>%
  separate(Car, c("Make", "Model"), sep = " ")
#merging columns into 1
data5$Car <- paste(data5$Make, data5$Model, sep = " ")
...
data1_temp <- data1[complete.cases(data1[,2]),]
data1_temp <- drop_na(data1, Right_MNE)
#replace NAs
