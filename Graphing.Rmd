...
ggplot(dataframe, aes(x = Sepal.Length, y=Sepal.Width, colour = Species, shape = Species)) +
  geom_point() +
#Include line
  geom_vline(xintercept = 6, size = 0.5, color = "orange") +
...
ggplot(dataframe, aes(x = Sepal.Length, fill = Species)) +
  geom_bar(stat = "count") +
#Second type of coord system
  coord_cartesian(
#Set axis limits
    xlim = c(4,8),
#Make bars sit on bottom row
    expand = FALSE
  ) +
